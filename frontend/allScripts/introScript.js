...
const dialogue3 = ["... you know the code. 2-4-1-5. you enter."];
const dialogue4 = [
...
const dialogue7 = ["sleep is all you need"];
const dialogue8 = ["I think I should go to class."];
const dialogue9 = [
  "I have to work",
  "on my Programmation assignement",
  "Lets start coding !",
];
const dialogue10 = ["Wait. What is this file?", "Should i open it"];
...
function didVote() {
  ...
  if (vote) {
    output.textContent =
      "Thankyou for voting " + vote + " and your comment " + words;
  } else {
