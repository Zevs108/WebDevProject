...
const startSceneInfo = {
  scene_1: {
    img: "../OpenAssets/1_blackScreen.jpg",
    text: ["What is happening? Is it off?"],
    nextScene: "scene_2",
  },
  scene_2: {
    img: "../OpenAssets/2_rebooting.jpg",
    text: ["Oh, it's rebooting.", "I guess I will just wait?"],
    nextScene: "scene_3",
  },
  scene_3: {
    img: "../OpenAssets/3+5+29+31_PC.jpg",
    text: [
      "Ok, that was weird.",
      "Maybe some prank?",
  ...
  scene_6: {
    img: "../OpenAssets/6_metro.jpg",
    text: ["I hate the 1 hour of metro"],
    nextScene: "scene_7",
  },
  scene_7: {
    img: "../OpenAssets/7+9+24+33_bed.jpg",
  ...
  scene_9: {
    img: "../OpenAssets/7+9+24+33_bed.jpg",
    text: [
      "You open your eyes. You got 8 hours of sleep and still feel tired.",
      "You think to yourself: What is wrong with me?",
    ],
    nextScene: "scene_10",
  },
  scene_10: {
    img: "../OpenAssets/10+26_lockers.jpg",
    text: [
  ...
  scene_11: {
    img: "../OpenAssets/11_wall.jpg",
    text: ["Wait. Where is the door?", "Hello? What happened?"],
    nextScene: "scene_12",
  },
  scene_12: {
    img: "../OpenAssets/12_hallway.jpg",
    text: [
  ...
  scene_13: {
    img: "../OpenAssets/13_NourLabs.jpg",
    text: ["Here is Daniel. Should I tell him about the missing lounge?"],
    nextScene: null,
  },
  scene_14_YES: {
    img: "../OpenAssets/14_NourLabsTalk.jpg",
    text: [
  ...
  scene_15_NO: {
    img: "../OpenAssets/15_PC.jpg",
    text: ["Wait, the file.. it's here."],
    nextScene: "scene_15",
  },
  scene_15: {
    img: "../OpenAssets/16_PCListen.jpg",
    text: ["Listen to me."],
    nextScene: null,
  },
  scene_16_listen: {
  ...
  scene_21: {
    img: "../OpenAssets/21_dream.jpg",
    text: ["What is happening? This is just a dream."],
    nextScene: "scene_22",
  },
  scene_22: {
    img: "../OpenAssets/22_dream.jpg",
  ...
  scene_25: {
    img: "../OpenAssets/25+32_metro.jpg",
    text: ["You decide to catch up on your sleep in the metro."],
    nextScene: "scene_26",
  },
  scene_26: {
    img: "../OpenAssets/10+26_lockers.jpg",
    text: ["You leave your lunch in your locker and go to the lounge."],
    nextScene: "scene_27",
  },
  scene_27: {
    img: "../OpenAssets/27_door.jpg",
    text: ["You enter the code. 2-4-1-5"],
    nextScene: "scene_28",
  },
  scene_28: {
    img: "../OpenAssets/28_Lounge.jpg",
    text: ["You chill in the lounge until your class starts."],
    nextScene: "scene_29",
  },
  scene_29: {
    img: "../OpenAssets/3+5+29+31_PC.jpg",
    text: ["You work on your programming projects."],
    nextScene: "scene_30",
  },
  scene_30: {
    img: "none",
  ...
  scene_31: {
    img: "../OpenAssets/3+5+29+31_PC.jpg",
    text: ["You are tired and decide to go home."],
    nextScene: "scene_32",
  },
  scene_32: {
    img: "../OpenAssets/25+32_metro.jpg",
    text: [" It takes you 1 hour to get home."],
    nextScene: "scene_33",
  },
  scene_33: {
    img: "../OpenAssets/7+9+24+33_bed.jpg",
  ...
  scene_28_secret: {
    img: "../OpenAssets/28S+29S+30S_wallGlitch.jpg",
    text: ["👎︎⚐︎☠︎🕯︎❄︎ ☹︎☜︎❄︎ ☟︎✋︎💣︎ 🕈︎✋︎☠︎📬︎... choose"],
    nextScene: null,
  },
  scene_29_class: {
    img: "../OpenAssets/29S+30S_Class.jpg",
    text: ["You look at the screen.", "You see HIM again."],
    nextScene: null,
  },
  scene_29_help: {
    img: "../OpenAssets/28S+29S+30S_wallGlitch.jpg",
  ...
  scene_30_wait: {
    img: "../OpenAssets/28S+29S+30S_wallGlitch.jpg",
    text: ["You stand still.", "You wait.", "You wait.", "You... go to class."],
    nextScene: "scene_29_class",
  },

  scene_30_listen: {
    img: "../OpenAssets/30S_listen.jpg",
    text: [
  ...
  scene_31_ending: {
    img: null,
    text: ["👍︎✌︎☠︎☠︎⚐︎❄︎ 👍︎⚐︎☠︎☠︎☜︎👍︎❄︎ ❄︎⚐︎ 🕈︎⚐︎☼︎☹︎👎︎"],
  },
};
...
function changeScene() {
  currentScene = startSceneInfo[currentScene]["nextScene"];
  countText = 0;
...
function getChoice() {
  ...
  choiceTag.addEventListener("click", (e) => {
    if (e.target === btn1) {
      startSceneInfo[currentScene]["nextScene"] =
        choiceScenes[currentChoice][0];
      changeScene();
      showNextLine();
